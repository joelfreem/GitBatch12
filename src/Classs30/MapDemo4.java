...
public class MapDemo4 {
    ...
    public static void main(String[] args) {
        ...
        //first we are getting the set from the map then we are getting the iterator
        //on that set
        ...
        while(iterator.hasNext()){//checks if there are still elements left in the iterator
            ...
            if(key.contains("e")&&value>=20){
                iterator.remove();//if both the conditions are satisfied we remove the elements from the map
            }
        }
